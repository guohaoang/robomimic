...
import robomimic.envs.env_robosuite_task_id as MultiTaskEnvWrapper
...
TASK_ID_KEY = "task_id"
TASK_ID_SHAPE = (3,)
TYPE_TO_TASK_ID = {'worse':[0,0,1], 'okay':[0,1,0], 'better':[1,0,0]}
...
def train_multi_taks(config, device):
    ...
    shape_meta = get_shape_meta_with_task_id(shape_meta)
